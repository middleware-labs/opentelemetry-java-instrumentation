...
dependencies {
quarkusDeployment("io.quarkus:quarkus-mutiny-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-resteasy-reactive-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-arc-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-netty-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-resteasy-reactive-common-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-jsonp-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-vertx-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-smallrye-context-propagation-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-vertx-http-deployment:2.16.7.Final")
quarkusDeployment("io.quarkus:quarkus-core-deployment:2.16.7.Final")
}
typealias PrintWriter = java.io.PrintWriter
typealias FileWriter = java.io.FileWriter
tasks.register("listQuarkusDependencies") {
    val writer = PrintWriter(FileWriter("/tmp/18376831032065116933.txt"))
