...
dependencies {
quarkusDeployment("io.quarkus:quarkus-mutiny-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-resteasy-reactive-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-core-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-resteasy-reactive-common-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-arc-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-jsonp-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-smallrye-context-propagation-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-vertx-http-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-netty-deployment:3.0.1.Final")
quarkusDeployment("io.quarkus:quarkus-vertx-deployment:3.0.1.Final")
}
typealias PrintWriter = java.io.PrintWriter
typealias FileWriter = java.io.FileWriter
tasks.register("listQuarkusDependencies") {
    val writer = PrintWriter(FileWriter("/tmp/10215469570122461629.txt"))
