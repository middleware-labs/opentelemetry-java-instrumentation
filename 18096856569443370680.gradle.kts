...
dependencies {
quarkusDeployment("io.quarkus:quarkus-vertx-http-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-resteasy-reactive-common-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-resteasy-reactive-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-arc-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-netty-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-vertx-core-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-core-deployment:1.11.0.Final")
quarkusDeployment("io.quarkus:quarkus-jsonp-deployment:1.11.0.Final")
}
typealias PrintWriter = java.io.PrintWriter
typealias FileWriter = java.io.FileWriter
tasks.register("listQuarkusDependencies") {
    val writer = PrintWriter(FileWriter("/tmp/10231847652539667906.txt"))
